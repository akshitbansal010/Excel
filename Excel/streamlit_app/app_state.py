...
def _init_pagination():
    ...
    if 'page_size' not in st.session_state:
        from streamlit_app.app_config import DEFAULT_PAGE_SIZE
...
def add_to_undo_stack(action: str, data: Dict[str, Any]):
    ...
    from streamlit_app.app_config import MAX_UNDO_HISTORY
...
def is_large_dataset(df) -> bool:
    ...
    from streamlit_app.app_config import LARGE_DATASET_THRESHOLD
